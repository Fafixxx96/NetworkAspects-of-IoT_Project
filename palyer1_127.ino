      ...
      case 6: //SIGN SCREEN
       if( (x<=20 && x>=0) && (y<=20 && y>=0) ){
        ...
        switch(protocol){
          ...
          case 1: //MQTT___________________________________________________________________
            if( (x<=20 && x>=0) && (y<=20 && y>=0) ){
              protocolScreen();
              caso = 3;
              segno = '-';
            ...
            case 2: //CoAP______________________________________________________________________________
              if( (x<=20 && x>=0) && (y<=20 && y>=0) ){
                protocolScreen();
                caso = 3;
                segno = '-';
      ...
      case 8: //gameScreen
       if( (x<=20 && x>=0) && (y<=20 && y>=0) ){
        ...
        switch(protocol){
                ...
                for(int i=0; i<3; ++i)
                  for(int j=0; j<3; ++j)
                    if( ((matrix[i][j] != 'X') && (matrix[i][j] != 'O')) && ( x<=((j+1)*50)+95 && x>=(j*50)+95 && y<=((i+1)*50)+60 && y>=(i*50)+60 ) ){
                      ...
                      int putid = coap.put(IPAddress(192, 168, 1, 127), 5680, "mossa", msg, COAP_CON);
          ...
          case 1: //MQTT___________________________________________________________________________
...
void subscribeMessage(char topic[]){ client.subscribe(topic); }
